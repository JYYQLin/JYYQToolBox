//
//  JY_Refresh_CollectionView.swift
...
extension JY_Refresh_CollectionView {
    @objc dynamic open func yq_set_refresh() {
        ...
        mj_footer = MJRefreshAutoStateFooter(refreshingTarget: self, refreshingAction: #selector(yq_request_more_data))
